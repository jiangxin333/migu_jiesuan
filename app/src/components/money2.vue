<template>
	<div style="background: #FFFFFF;">
		...
		<van-popup v-model="adShow"><img src="https://quzhuan.oss-cn-beijing.aliyuncs.com/img/task.png" class="qr_img" style="width: 100%!important;" alt @click="toMentor" /></van-popup>
	</div>
</template>
