<template>
	<div class="navTop" style="background: #FFFFFF;padding-bottom: 60px;">
		...
		<van-tabs v-model="active" sticky animated :line-width="lineWidth" color="#FF0000" title-active-color="#FF0000"
		...
		<van-popup v-model="ermShow" style="background: transparent;">
			...
			<p style="text-align: center;margin-top: 5px;">
				<input type="button" class="ermBtn shareBtn" value="长按可保存图片或分享给朋友" style="border:none;background: transparent; color: #FFFFFF;width: 220px;font-size: 14px;" />
			</p>
		</van-popup>
